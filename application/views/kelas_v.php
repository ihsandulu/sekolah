                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <?php if(isset($_POST['new'])||isset($_POST['edit'])){?>
                                <div class="">
                                    <?php if(isset($_POST['edit'])){$namabutton='name="change"';$judul="Update Class";}else{$namabutton='name="create"';$judul="New Class";}?>	
                                    ...
                                    <div class="col-md-offset-2 col-md-10 alert alert-danger alert-dismissable fade in" id="cekkelas" style="display:none;">
                                      ...
                                      $("#kelas_name").keyup(function(){
                                          $.get("<?=site_url("api/cekkelas");?>",{kelas_name:$("#kelas_name").val()})
                                          .done(function(data){
                                            if(data=="ada"){
                                                $("#cekkelas").fadeIn();$("#submit").prop("disabled","disabled");
                                            }else{
                                                $("#cekkelas").fadeOut();$("#submit").prop("disabled","");
                                            }
                                          });
                                      });
                                      </script>
