...
<body>
	<div class="login row">
		<div class="col-md-12 row" id="judul">
			<div class="col-md-12">
				<img src="<?= base_url("assets/images/global/" . $identity->identity_picture); ?>" style="height:35px; width:auto;">
			</div>
			<div class="col-md-12">
		...
		<div class="col-md-12" id="form">
			<form method="post">
				...
				<input type="password" autocomplete="off" name="user_password" placeholder="Password" required="required" />
				<input type="hidden" autocomplete="on" name="sekolah_id" placeholder="Kode Sekolah" value="1" />
